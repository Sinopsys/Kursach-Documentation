...
\titleDesignedBy{Студент группы БПИ 151 НИУ ВШЭ}{Суровцев М.А.}
...
\titleName{Клиент-Серверное Web Приложение для Управления Скидками в Розничных Сетях}
\workTypeId{RU.17701729.506900 T3 01-1}
